...
class EstatisticaErroServiceTest extends TestCase
{
    ...
    public function test_calcula_acertos_erros_e_em_branco_por_questao(): void
    {
        ...
        Resposta::create(['prova_codigo' => $prova->codigo, 'ra' => '3', 'questao_numero' => 1, 'resposta' => 'C']);
        Resposta::create(['prova_codigo' => $prova->codigo, 'ra' => '4', 'questao_numero' => 1, 'resposta' => '']);
        ...
        $stats = (new EstatisticaErroService)->calcular($prova);
    ...
    {
        $prova = Prova::create([]);
        $outraProva = Prova::create([]);
        Questao::create(['prova_codigo' => $prova->codigo, 'numero' => 1, 'gabarito' => 'A']);
        Questao::create(['prova_codigo' => $outraProva->codigo, 'numero' => 1, 'gabarito' => 'A']);

        Resposta::create(['prova_codigo' => $prova->codigo, 'ra' => '1', 'questao_numero' => 1, 'resposta' => 'B']);
        Resposta::create(['prova_codigo' => $outraProva->codigo, 'ra' => '1', 'questao_numero' => 1, 'resposta' => 'C']);

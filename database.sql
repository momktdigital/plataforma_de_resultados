...
('hcaptcha_ativo', '0', 'Ativar hCaptcha (1 = Sim, 0 = Não)'),
('hcaptcha_site_key', '', 'Chave de Site (Site Key) do hCaptcha'),
('hcaptcha_secret_key', '', 'Chave Secreta (Secret Key) do hCaptcha'),
